...
double Arx5System::merge_gripper(double joint7, double joint8) const
{
...
CallbackReturn Arx5System::on_init(
...
PLUGINLIB_EXPORT_CLASS(
  arx5_ros2_control::Arx5System, hardware_interface::SystemInterface)
